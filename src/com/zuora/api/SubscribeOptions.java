...
public class SubscribeOptions  implements java.io.Serializable {
    private java.lang.Boolean applyCreditBalance;

    private com.zuora.api.ExternalPaymentOptions externalPaymentOptions;
    ...
    public SubscribeOptions(
           java.lang.Boolean applyCreditBalance,
           com.zuora.api.ExternalPaymentOptions externalPaymentOptions,
    ...
    /**
     * Gets the applyCreditBalance value for this SubscribeOptions.
     * 
     * @return applyCreditBalance
     */
    public java.lang.Boolean getApplyCreditBalance() {
        return applyCreditBalance;
    }


    /**
     * Sets the applyCreditBalance value for this SubscribeOptions.
     * 
     * @param applyCreditBalance
     */
    public void setApplyCreditBalance(java.lang.Boolean applyCreditBalance) {
        this.applyCreditBalance = applyCreditBalance;
    }


    /**
     * Gets the externalPaymentOptions value for this SubscribeOptions.
     * 
    ...
    /**
     * Sets the externalPaymentOptions value for this SubscribeOptions.
     * 
     * @param externalPaymentOptions
     */
    public void setExternalPaymentOptions(com.zuora.api.ExternalPaymentOptions externalPaymentOptions) {
        this.externalPaymentOptions = externalPaymentOptions;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.applyCreditBalance==null && other.getApplyCreditBalance()==null) || 
             (this.applyCreditBalance!=null &&
              this.applyCreditBalance.equals(other.getApplyCreditBalance()))) &&
            ((this.externalPaymentOptions==null && other.getExternalPaymentOptions()==null) || 
             (this.externalPaymentOptions!=null &&
              this.externalPaymentOptions.equals(other.getExternalPaymentOptions()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getApplyCreditBalance() != null) {
            _hashCode += getApplyCreditBalance().hashCode();
        }
        if (getExternalPaymentOptions() != null) {
            _hashCode += getExternalPaymentOptions().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("applyCreditBalance");
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.zuora.com/", "ApplyCreditBalance"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("externalPaymentOptions");
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.zuora.com/", "ExternalPaymentOptions"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://api.zuora.com/", "ExternalPaymentOptions"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
