...
public class ErrorCode implements java.io.Serializable {
    ...
    public static final java.lang.String _LOCK_COMPETITION = "LOCK_COMPETITION";
    ...
    public static final java.lang.String _PDF_QUERY_ERROR = "PDF_QUERY_ERROR";
    public static final java.lang.String _REQUEST_EXCEEDED_LIMIT = "REQUEST_EXCEEDED_LIMIT";
    public static final java.lang.String _REQUEST_EXCEEDED_RATE = "REQUEST_EXCEEDED_RATE";
    public static final java.lang.String _REQUEST_REJECTED = "REQUEST_REJECTED";
    public static final java.lang.String _TEMPORARY_ERROR = "TEMPORARY_ERROR";
    public static final java.lang.String _TRANSACTION_TERMINATED = "TRANSACTION_TERMINATED";
    ...
    public static final ErrorCode LOCK_COMPETITION = new ErrorCode(_LOCK_COMPETITION);
    ...
    public static final ErrorCode PDF_QUERY_ERROR = new ErrorCode(_PDF_QUERY_ERROR);
    public static final ErrorCode REQUEST_EXCEEDED_LIMIT = new ErrorCode(_REQUEST_EXCEEDED_LIMIT);
    public static final ErrorCode REQUEST_EXCEEDED_RATE = new ErrorCode(_REQUEST_EXCEEDED_RATE);
    public static final ErrorCode REQUEST_REJECTED = new ErrorCode(_REQUEST_REJECTED);
    public static final ErrorCode TEMPORARY_ERROR = new ErrorCode(_TEMPORARY_ERROR);
    public static final ErrorCode TRANSACTION_TERMINATED = new ErrorCode(_TRANSACTION_TERMINATED);
    public static final ErrorCode TRANSACTION_TIMEOUT = new ErrorCode(_TRANSACTION_TIMEOUT);
