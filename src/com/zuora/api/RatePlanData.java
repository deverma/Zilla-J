...
public class RatePlanData  implements java.io.Serializable {
    ...
    private com.zuora.api.object.SubscriptionProductFeature[] subscriptionProductFeatureList;
    ...
    public RatePlanData(
           ...
           com.zuora.api.object.SubscriptionProductFeature[] subscriptionProductFeatureList) {
    ...
    /**
     * Gets the subscriptionProductFeatureList value for this RatePlanData.
     * 
     * @return subscriptionProductFeatureList
     */
    public com.zuora.api.object.SubscriptionProductFeature[] getSubscriptionProductFeatureList() {
        return subscriptionProductFeatureList;
    }


    /**
     * Sets the subscriptionProductFeatureList value for this RatePlanData.
     * 
     * @param subscriptionProductFeatureList
     */
    public void setSubscriptionProductFeatureList(com.zuora.api.object.SubscriptionProductFeature[] subscriptionProductFeatureList) {
        this.subscriptionProductFeatureList = subscriptionProductFeatureList;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.subscriptionProductFeatureList==null && other.getSubscriptionProductFeatureList()==null) || 
             (this.subscriptionProductFeatureList!=null &&
              java.util.Arrays.equals(this.subscriptionProductFeatureList, other.getSubscriptionProductFeatureList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSubscriptionProductFeatureList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSubscriptionProductFeatureList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSubscriptionProductFeatureList(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("subscriptionProductFeatureList");
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.zuora.com/", "SubscriptionProductFeatureList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://object.api.zuora.com/", "SubscriptionProductFeature"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://api.zuora.com/", "SubscriptionProductFeature"));
        typeDesc.addFieldDesc(elemField);
    }
