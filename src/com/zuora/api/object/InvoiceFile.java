...
public class InvoiceFile  extends com.zuora.api.object.ZObject  implements java.io.Serializable {
    ...
    private java.lang.String pdfFileUrl;
    ...
    /**
     * Gets the createdById value for this InvoiceFile.
     * 
     * @return createdById
     */
    ...
    /**
     * Sets the createdById value for this InvoiceFile.
     * 
     * @param createdById
     */
    ...
    /**
     * Gets the createdDate value for this InvoiceFile.
     * 
     * @return createdDate
     */
    ...
    /**
     * Sets the createdDate value for this InvoiceFile.
     * 
     * @param createdDate
     */
    ...
    /**
     * Gets the invoiceId value for this InvoiceFile.
     * 
     * @return invoiceId
     */
    ...
    /**
     * Sets the invoiceId value for this InvoiceFile.
     * 
     * @param invoiceId
     */
    ...
    /**
     * Gets the pdfFileUrl value for this InvoiceFile.
     * 
     * @return pdfFileUrl
     */
    ...
    /**
     * Sets the pdfFileUrl value for this InvoiceFile.
     * 
     * @param pdfFileUrl
     */
    ...
    /**
     * Gets the updatedById value for this InvoiceFile.
     * 
     * @return updatedById
     */
    ...
    /**
     * Sets the updatedById value for this InvoiceFile.
     * 
     * @param updatedById
     */
    ...
    /**
     * Gets the updatedDate value for this InvoiceFile.
     * 
     * @return updatedDate
     */
    ...
    /**
     * Sets the updatedDate value for this InvoiceFile.
     * 
     * @param updatedDate
     */
    ...
    /**
     * Gets the versionNumber value for this InvoiceFile.
     * 
    ...
    /**
     * Sets the versionNumber value for this InvoiceFile.
     * 
     * @param versionNumber
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InvoiceFile)) return false;
        InvoiceFile other = (InvoiceFile) obj;
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.pdfFileUrl==null && other.getPdfFileUrl()==null) || 
             (this.pdfFileUrl!=null &&
              this.pdfFileUrl.equals(other.getPdfFileUrl()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getPdfFileUrl() != null) {
            _hashCode += getPdfFileUrl().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InvoiceFile.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://object.api.zuora.com/", "InvoiceFile"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("pdfFileUrl");
        elemField.setXmlName(new javax.xml.namespace.QName("http://object.api.zuora.com/", "PdfFileUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://object.api.zuora.com/", "VersionNumber"));
