...
public class Login_element implements com.sforce.ws.bind.XMLizable {
	 ...
	 */
	private static final com.sforce.ws.bind.TypeInfo username__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "username",
	...
	private static final com.sforce.ws.bind.TypeInfo password__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:enterprise.soap.sforce.com", "password",
			"http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
	...
	protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
			com.sforce.ws.bind.TypeMapper __typeMapper)
			throws java.io.IOException {
		__typeMapper.writeString(__out, username__typeInfo, username,
				username__is_set);
		__typeMapper.writeString(__out, password__typeInfo, password,
				password__is_set);
	}
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
		...
		if (__typeMapper.verifyElement(__in, username__typeInfo)) {
			setUsername((java.lang.String) __typeMapper.readString(__in,
					username__typeInfo, java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, password__typeInfo)) {
			setPassword((java.lang.String) __typeMapper.readString(__in,
					password__typeInfo, java.lang.String.class));
		}
	}
